...
export class OllamaService {
    ...
    async generateLearningContent(topics: string[]): Promise<LearningContent | null> {
        try {
            ...
            const prompt = `Generate a learning content for a developer about "${randomTopic}". 
            
            Return ONLY a JSON object with this exact structure:
            {
                "funFact": "A short, interesting fact about ${randomTopic} (1-2 sentences)",
                "question": "A single multiple choice question about ${randomTopic}",
            ...
            Make it educational but engaging. The question should be practical and relevant to developers.`;
            ...
            if (jsonMatch) {
                ...
                return this.createFallbackContent(randomTopic);
            }
